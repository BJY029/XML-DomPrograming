...
public class UpdateFrame {
	...
	private void initialize() {
		...
		JLabel InsertLabel = new JLabel("Update");
		InsertLabel.setFont(new Font("굴림", Font.PLAIN, 24));
		...
		JLabel InsertionLabel = new JLabel("Select the node to update");
		InsertionLabel.setFont(new Font("굴림", Font.PLAIN, 20));
		InsertionLabel.setHorizontalAlignment(SwingConstants.CENTER);
		scrollPane.setColumnHeaderView(InsertionLabel);
		...
		ModifyButton.setFont(new Font("굴림", Font.PLAIN, 20));
		ModifyButton.addActionListener(e -> ModifyNode());
		ModifyButton.setBounds(758, 581, 127, 45);
	...
	private void InitAll() {
		...
		NodeValueField.setEnabled(false);
		AttributeValueField.setText("");
	...
	private void activeAvailableField()
	{
		...
		case Node.TEXT_NODE:
			NodeValueField.setText(selectedNode.getNodeValue());
			NodeValueField.setEnabled(true);
			break;
